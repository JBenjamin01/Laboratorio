...
public class VideoJuego4 {
    ...
    public static void mostrarTablero(ArrayList<ArrayList<Soldado>> tablero, ArrayList<Soldado> ejercito1, 
        ...
        System.out.println("Tablero de la batalla, las unidades del ejercito 1 estaran con corchetes," +
                            " del ejercito 2 con signos menor y mayor que:");
        System.out.println("\n           A     B     C     D     E     F     G     H     I     J");
        System.out.println();
        System.out.println("        -------------------------------------------------------------");
    ...
    public static void mostrarDatosSoldado(Soldado soldado) {
        if (soldado != null) {
            ...
            System.out.println("No hay soldados en este ejército.");
        }
    }
